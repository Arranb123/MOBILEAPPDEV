...
const styles = StyleSheet.create({
  ...
  notes: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB', borderWidth: 1, color: '#374151', fontSize: 14, marginBottom: 18, padding: 12 },
  buttonSpacing: { marginTop: 10 },
  logsSection: { marginTop: 28 },
  logsTitle: { color: '#111827', fontSize: 16, fontWeight: '700', marginBottom: 12 },
  logItem: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB', borderWidth: 1, marginBottom: 8, padding: 12 },
  logStatus: { color: '#111827', fontSize: 14, fontWeight: '600' },
  logDate: { color: '#6B7280', fontSize: 12, marginTop: 2 },
  logNotes: { color: '#374151', fontSize: 13, marginTop: 4 },
});
